...
public class ModelAntennasBack extends ModelRenderer {
	...
	public ModelAntennasBack(BipedModel base) {
		...
		rightantenna1.setPos(3F, -10.9F, 0F);
		...
		leftantenna1.setPos(-3F, -10.9F, 0F);
		...
		rightantenna2.setPos(4.6F, -12.2F, 3.4F);
		...
		leftantenna2.setPos(-4.6F, -12.2F, 3.4F);
