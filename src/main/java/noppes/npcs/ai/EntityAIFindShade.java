...
public class EntityAIFindShade extends Goal
{
    ...
    public EntityAIFindShade(CreatureEntity par1CreatureEntity)
    {
    ...
    public boolean canUse()
    {
        ...
        else if (!this.level.canSeeSky(new BlockPos(this.theCreature.getX(), this.theCreature.getBoundingBox().minY, this.theCreature.getZ())))
        {
            return false;
        }
        else
