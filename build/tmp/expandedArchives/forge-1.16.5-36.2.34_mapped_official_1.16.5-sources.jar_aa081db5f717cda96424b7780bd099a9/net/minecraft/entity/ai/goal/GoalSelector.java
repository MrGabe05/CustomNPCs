...
public class GoalSelector {
   ...
   public static final PrioritizedGoal NO_GOAL = new PrioritizedGoal(Integer.MAX_VALUE, new Goal() {
   ...
   public final Map<Goal.Flag, PrioritizedGoal> lockedFlags = new EnumMap<>(Goal.Flag.class);
   public final Set<PrioritizedGoal> availableGoals = Sets.newLinkedHashSet();
   public final Supplier<IProfiler> profiler;
   public final EnumSet<Goal.Flag> disabledFlags = EnumSet.noneOf(Goal.Flag.class);
   public int newGoalRate = 3;
