...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   public final ServerWorldLightManager lightEngine;
   public final ThreadTaskExecutor<Runnable> mainThreadExecutor;
   public final ChunkGenerator generator;
   public final Supplier<DimensionSavedDataManager> overworldDataStorage;
   public final PointOfInterestManager poiManager;
   public final LongSet toDrop = new LongOpenHashSet();
   public boolean modified;
   public final ChunkTaskPriorityQueueSorter queueSorter;
   public final ITaskExecutor<ChunkTaskPriorityQueueSorter.FunctionEntry<Runnable>> worldgenMailbox;
   public final ITaskExecutor<ChunkTaskPriorityQueueSorter.FunctionEntry<Runnable>> mainThreadMailbox;
   ...
   public final TemplateManager structureManager;
   public final File storageFolder;
   public final PlayerGenerationTracker playerMap = new PlayerGenerationTracker();
   public final Int2ObjectMap<ChunkManager.EntityTracker> entityMap = new Int2ObjectOpenHashMap<>();
   public final Long2ByteMap chunkTypeCache = new Long2ByteOpenHashMap();
   public final Queue<Runnable> unloadQueue = Queues.newConcurrentLinkedQueue();
