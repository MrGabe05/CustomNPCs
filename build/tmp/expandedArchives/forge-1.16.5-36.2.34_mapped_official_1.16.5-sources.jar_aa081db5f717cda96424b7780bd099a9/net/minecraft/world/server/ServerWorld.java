...
public class ServerWorld extends World implements ISeedReader, net.minecraftforge.common.extensions.IForgeWorldServer {
   ...
   public final Map<UUID, Entity> entitiesByUuid = Maps.newHashMap();
   public final Queue<Entity> toAddAfterTick = Queues.newArrayDeque();
   public final List<ServerPlayerEntity> players = Lists.newArrayList();
   public final ServerChunkProvider chunkSource;
   ...
   public final Teleporter portalForcer;
   public final ServerTickList<Block> blockTicks = new ServerTickList<>(this, (p_205341_0_) -> {
      return p_205341_0_ == null || p_205341_0_.defaultBlockState().isAir();
   }, Registry.BLOCK::getKey, this::tickBlock);
   public final ServerTickList<Fluid> liquidTicks = new ServerTickList<>(this, (p_205774_0_) -> {
      return p_205774_0_ == null || p_205774_0_ == Fluids.EMPTY;
   }, Registry.FLUID::getKey, this::tickLiquid);
   public final Set<PathNavigator> navigations = Sets.newHashSet();
   public final RaidManager raids;
   public final ObjectLinkedOpenHashSet<BlockEventData> blockEvents = new ObjectLinkedOpenHashSet<>();
   public boolean handlingTick;
   public final List<ISpecialSpawner> customSpawners;
   @Nullable
   public final DragonFightManager dragonFight;
   public final StructureManager structureFeatureManager;
