...
public final class Biome extends net.minecraftforge.registries.ForgeRegistryEntry.UncheckedRegistryEntry<Biome> {
   ...
   public final Map<Integer, List<Structure<?>>> structuresByStep = Registry.STRUCTURE_FEATURE.stream().collect(Collectors.groupingBy((p_242435_0_) -> {
      return p_242435_0_.step().ordinal();
   }));
   public static final PerlinNoiseGenerator TEMPERATURE_NOISE = new PerlinNoiseGenerator(new SharedSeedRandom(1234L), ImmutableList.of(0));
   ...
   public final Biome.Climate climateSettings;
   public final BiomeGenerationSettings generationSettings;
   public final MobSpawnInfo mobSettings;
   public final float depth;
   public final float scale;
   public final Biome.Category biomeCategory;
   public final BiomeAmbience specialEffects;
   public final ThreadLocal<Long2FloatLinkedOpenHashMap> temperatureCache = ThreadLocal.withInitial(() -> {
      return Util.make(() -> {
