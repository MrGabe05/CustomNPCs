...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
   public static ResourceLocation INVENTORY_LOCATION = new ResourceLocation("textures/gui/container/inventory.png");
   public int imageWidth = 176;
   public int imageHeight = 166;
   public int titleLabelX;
   public int titleLabelY;
   ...
   public ItemStack draggingItem = ItemStack.EMPTY;
   public int snapbackStartX;
   public int snapbackStartY;
   public long snapbackTime;
   public ItemStack snapbackItem = ItemStack.EMPTY;
   public long quickdropTime;
   public Set<Slot> quickCraftSlots = Sets.newHashSet();
   public boolean isQuickCrafting;
   public int quickCraftingType;
   public int quickCraftingButton;
   public boolean skipNextRelease;
   public int quickCraftingRemainder;
   public long lastClickTime;
   public int lastClickButton;
   public boolean doubleclick;
   public ItemStack lastQuickMoved = ItemStack.EMPTY;
